...
# Initialize default video URL
DEFAULT_VIDEO_URL = "https://valiw.hakunaymatata.com/resource/fb9561c7e1582ca8f8d99de1098bf804.mp4?auth_key=1750850458-0-0-3ae71ad5aa6e41c85da8cb8bd02e40cc"
...
def get_current_video_url():
    ...
    return session.get('current_video_url', DEFAULT_VIDEO_URL)
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p class="small text-break">{current_url[:100]}...</p>
                    </div>
                </div>
...
if __name__ == '__main__':
    ...
    logger.info(f"Default video URL: {DEFAULT_VIDEO_URL[:50]}...")
